...
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(78);
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_function_name__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(81);
/* harmony import */ var core_js_modules_es_function_name__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_function_name__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var core_js_modules_es_regexp_exec__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(56);
/* harmony import */ var core_js_modules_es_regexp_exec__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_regexp_exec__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var core_js_modules_es_string_match__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(84);
...
var app = new Vue({
  ...
  methods: {
    selectView: function selectView(e, indexGroup) {
      var menuLi = e.target.parentElement;
      if (e.target.tagName === 'LI') menuLi = e.target;
      var menuLiSublings = menuLi.parentElement.children;

      for (var i = 0; i < menuLiSublings.length; i++) {
    ...
    selectSize: function selectSize(e, indexGroup) {
      var menuLi = e.target.parentElement;
      if (e.target.tagName === 'LI') menuLi = e.target;
      var menuLiSublings = menuLi.parentElement.children;
    ...
    selectFormat: function selectFormat(e, indexGroup) {
      var menuLi = e.target.parentElement;
      if (e.target.tagName === 'LI') menuLi = e.target;
    ...
    selectTab: function selectTab(e, indexGroup, cardNumber) {
    ...
    reestablishNameFileWebp: function reestablishNameFileWebp(e, numberGroup, cardNumber) {
      e.target.name = "shop_start_promocards[group_".concat(numberGroup, "_card_background_image_webp_").concat(cardNumber, "]");
      var inputTextWebp = document.querySelector("#group_".concat(numberGroup, "_input_text_webp_").concat(cardNumber));
      inputTextWebp.name = '';
      inputTextWebp.value = '';
    },
    reestablishNameFileJpg: function reestablishNameFileJpg(e, numberGroup, cardNumber) {
      e.target.name = "shop_start_promocards[group_".concat(numberGroup, "_card_background_image_jpg_").concat(cardNumber, "]");
      var inputTextJpg = document.querySelector("#group_".concat(numberGroup, "_input_text_jpg_").concat(cardNumber));
      inputTextJpg.name = '';
      inputTextJpg.value = '';
    },
    delImageJpg: function delImageJpg(e, indexGroup, cardNumber) {
      var inputFileJpg = document.querySelector("#group_".concat(indexGroup + 1, "_input_file_jpg_").concat(cardNumber));
      var inputTextJpg = document.querySelector("#group_".concat(indexGroup + 1, "_input_text_jpg_").concat(cardNumber));
    ...
    delImageWebp: function delImageWebp(e, indexGroup, cardNumber) {
      var inputFileWebp = document.querySelector("#group_".concat(indexGroup + 1, "_input_file_webp_").concat(cardNumber));
      var inputTextWebp = document.querySelector("#group_".concat(indexGroup + 1, "_input_text_webp_").concat(cardNumber));
      var inputFileWebpNameDefault = inputFileWebp.name;
      var inputTextWebpNameDefault = inputTextWebp.name;
    ...
    delDate: function delDate(e, indexGroup, cardNumber) {
  ...
  created: function created() {
    ...
    for (var i = 0; i < this.groupCount; i++) {
      groupNumber++;
      var cardsFormat = document.querySelector("#format_group_".concat(groupNumber)).value;
      var cardsShow = 1;
      ...
      this.groupSettings.push({
        view: +document.querySelector("#views_group_".concat(groupNumber)).value,
        size: document.querySelector("#size_group_".concat(groupNumber)).value,
        format: cardsFormat,
        tabActive: 1,
        cardsShow: cardsShow,
        cardsInfo: []
      ...
      for (var j = 0; j < this.cardCount; j++) {
        ...
        this.groupSettings[i].cardsInfo.push({
          title: document.querySelector("#group_".concat(groupNumber, "_card_title_").concat(cardNumber)).value,
          description: document.querySelector("#group_".concat(groupNumber, "_card_description_").concat(cardNumber)).value,
          buttonText: document.querySelector("#group_".concat(groupNumber, "_card_button_text_").concat(cardNumber)).value,
          buttonClass: document.querySelector("#group_".concat(groupNumber, "_card_button_class_").concat(cardNumber)).value,
          link: document.querySelector("#group_".concat(groupNumber, "_card_link_").concat(cardNumber)).value,
          backgroundImageJpg: document.querySelector("#group_".concat(groupNumber, "_card_background_image_jpg_").concat(cardNumber)).value,
          backgroundImageWebp: document.querySelector("#group_".concat(groupNumber, "_card_background_image_webp_").concat(cardNumber)).value,
          timerDate: document.querySelector("#group_".concat(groupNumber, "_card_timer_date_").concat(cardNumber)).value,
          timerTime: document.querySelector("#group_".concat(groupNumber, "_card_timer_time_").concat(cardNumber)).value
        });
      }
    }
  }
